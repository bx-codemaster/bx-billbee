...
class OrderProduct
{
    ...
    /**
     * @Serializer\SerializedName("orders_products_id")
     * @Serializer\Type("int")
     */
    public ?int $ordersProductId = null;
    ...
    public function setEan(?string $ean): OrderProduct
    {
        $this->ean = $ean;
        return $this;
    }
    ...
    public function getOrdersProductId(): ?int
    {
        return $this->ordersProductId;
    }
    
    public function setOrdersProductId(?int $ordersProductId): OrderProduct
    {
